            ...
            <ul className="space-y-1">
              {alerts.map((m) => (
                <li key={m.id} className="flex items-start justify-between gap-2 text-[13px]">
                  ...
                  <span className="shrink-0 text-right text-[12.5px] break-keep text-muted">{m.riskNote}</span>
                </li>
              ))}
            </ul>
          </div>
                    ...
                    return (
                      <li key={m.id} className="px-3 py-2.5">
                        ...
                        <div className="mt-1.5 flex items-center gap-1.5">
                          ...
                          {m.riskNote ? <span className="text-[12.5px] break-keep text-muted">{m.riskNote}</span> : null}
                        </div>
