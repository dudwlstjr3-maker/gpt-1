    ...
    <li className="border-b border-border py-2.5 last:border-b-0">
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          <p className="text-[12.5px] font-semibold text-fg">{h.label}</p>
          {unavailable ? (
            <p className="mt-0.5 text-[10px]" style={{ color: 'var(--warn)' }}>
...
export function FngCycleView({ cycle }: { cycle: FngCycle }) {
  ...
  return (
    <div className="card p-3.5">
      ...
      <p className="mt-2 text-[11.5px] leading-relaxed break-keep text-muted">{cycle.phase.description}</p>
      ...
      <dl className="mt-2.5 flex gap-2 border-t border-border pt-2.5">
        <div className="flex-1 rounded-lg bg-surface-2 px-2 py-2 text-center">
          <dt className="text-[10px] text-muted">현재 점수</dt>
        ...
        <div className="flex-1 rounded-lg bg-surface-2 px-2 py-2 text-center">
          ...
          <dd className="tnum mt-0.5 text-[13px] font-bold" style={{ color: c.color(cycle.slope) }}>
            ...
            <span className="ml-0.5 text-[9px] font-normal text-subtle">점/일</span>
          </dd>
        </div>
      </dl>
      ...
      <p className="mt-2 border-t border-border pt-2 text-[10px] leading-relaxed break-keep text-subtle">
