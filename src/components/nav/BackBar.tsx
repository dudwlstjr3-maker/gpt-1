  ...
  return (
    <div className="px-3 pt-2">
      <button
        ...
        className="-ml-2 inline-flex items-center gap-1 rounded-lg px-2 py-1 text-[13px] font-semibold text-muted hover:text-fg focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-[var(--focus)]"
      >
