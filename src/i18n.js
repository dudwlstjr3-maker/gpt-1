...
const ko = {
  ...
  hand: {
    ...
    inputTitle: "핸드 입력",
    step1: "자리 배치", step1sub: "성향을 고른 뒤 자리를 탭하세요 · 같은 성향을 여러 자리에 놓아도 됩니다",
    step2: "이 핸드의 상대", step2sub: "여러 명을 앉혀도 계산은 지정한 상대 한 명 기준입니다",
    paintMe: "나", paintEmpty: "빈자리",
...
const en = {
  ...
  hand: {
    ...
    step1: "Seat the table", step1sub: "Pick a type, then tap seats · the same type can go in several seats",
    step2: "Opponent in this hand", step2sub: "Seat as many as you like — the maths uses the one you designate",
    paintMe: "Me", paintEmpty: "Empty",
